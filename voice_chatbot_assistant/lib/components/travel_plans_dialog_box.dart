...
void travelPlanDialogBox(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return const TravelPlanDialog();
    },
  );
}

class TravelPlanDialog extends StatefulWidget {
  const TravelPlanDialog({super.key});

  @override
  _TravelPlanDialogState createState() => _TravelPlanDialogState();
}
          ...
          Row(
            ...
            children: [
              GestureDetector(
                ...
                child: Image.asset(
                  'images/bookingLogo.png', // Path to your icon 1
              ...
              GestureDetector(
                onTap: () => connectionErrorCustomDialog(context),
                child: Image.asset(
                  'images/mmtLogo.png', // Path to your icon 2
                  height: 40, // Adjust size as needed
                  width: 40,
                ),
              ),
              GestureDetector(
                onTap: () => connectionErrorCustomDialog(context),
                child: Image.asset(
                  'images/agodaLogo.png', // Path to your icon 3
                  height: 40, // Adjust size as needed
                  width: 40,
                ),
              ),
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () => connectionErrorCustomDialog(context),
                child: Image.asset(
                  'images/ixigoLogo.png', // Path to your icon 4
                  height: 40, // Adjust size as needed
                  width: 40,
                ),
              ),
              GestureDetector(
                onTap: () => connectionErrorCustomDialog(context),
                child: Image.asset(
                  'images/flipkartLogo.png', // Path to your icon 5
                  height: 40, // Adjust size as needed
                  width: 40,
                ),
              ),
